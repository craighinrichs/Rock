...
namespace RockWeb.Blocks.Utility
{
    ...
    [DisplayName( "Active Small Group Details" )]
    [Category( "Utility" )]
    [Description( "Details of the Active Small Groups." )]
    ...
    public partial class ActiveSmallGroupDetails : Rock.Web.UI.RockBlock
    {
                    ...
                    if (group != null)
                    {
                        var groupDetails = new[]
                        {
                            new
                            {
                                group.Name,
                                group.Description,
                                CreatedDate = group.CreatedDateTime?.ToShortDateString() ?? "N/A",
                                ModifiedDate = group.ModifiedDateTime?.ToShortDateString() ?? "N/A",
                                GroupCapacity = group.GroupCapacity.HasValue ? group.GroupCapacity.Value.ToString() : "N/A"
                            }
                        };
                        gList.DataSource = groupDetails;
                        gList.DataBind();
                    }
                }
